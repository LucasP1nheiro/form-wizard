...
const PreviewDemo = () => {
  return (
    <>
      <div className="h-96 w-full lg:w-3/5 rounded-lg bg-black/5 dark:bg-white/5 duration-300 transition-all border border-border relative right-12 top-12 group-hover:scale-90">
        ...
        <div className="space-y-5">
          <div className="w-4/5 mx-auto bg-black/10 dark:bg-white/10 rounded-md h-12 border-l-[10px] border-emerald-600 flex items-center gap-3 px-4">
            <Heading1 />
            <h1 className="font-bold">Title field</h1>
          </div>
          <div className="w-4/5 mx-auto bg-black/10 dark:bg-white/10 rounded-md h-12 border-l-[10px] border-emerald-500 flex items-center gap-3 px-4">
            <ImParagraphLeft />
            <h1 className="font-bold">Paragraph field</h1>
          </div>
          <div className="w-4/5 mx-auto bg-black/10 dark:bg-white/10 rounded-md h-12 border-l-[10px] border-emerald-400 flex items-center gap-3 px-4">
            <FormInput />
